...
<a class="text-blue-600 font-medi hover:text-gray-600 text-sm xl:text-lg" href="https://github.com/Weibeck/Portfolio" title="View full project on github" target="_blank">
View Full Project
</a>
